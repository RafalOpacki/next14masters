...
export function graphql(
	source: "mutation CartAddItem($id: ID!, $input: MutationCartAddItemInput!) {\n  cartAddItem(id: $id, input: $input) {\n    id\n    items {\n      quantity\n      product {\n        id\n        name\n        description\n        price\n        images {\n          url\n        }\n      }\n    }\n  }\n}",
): typeof import("./graphql").CartAddItemDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "mutation CartChangeItemQuantity($id: ID!, $productId: ID!, $quantity: Int!) {\n  cartChangeItemQuantity(id: $id, productId: $productId, quantity: $quantity) {\n    id\n    items {\n      quantity\n      product {\n        id\n        name\n        description\n        price\n        images {\n          url\n        }\n      }\n    }\n  }\n}",
 ...
 */
export function graphql(
	source: "mutation CartFindOrCreate($id: ID, $input: MutationCartFindOrCreateInput = {}) {\n  cartFindOrCreate(id: $id, input: $input) {\n    id\n    items {\n      quantity\n      product {\n        id\n        name\n        description\n        price\n        categories {\n          name\n        }\n        images {\n          url\n        }\n      }\n    }\n  }\n}",
 ...
 */
export function graphql(
	source: "fragment CartItem on Cart {\n  id\n  items {\n    quantity\n    product {\n      id\n      name\n      description\n      price\n      categories {\n        name\n      }\n      images {\n        url\n      }\n    }\n  }\n}",
): typeof import("./graphql").CartItemFragmentDoc;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "mutation CartRemoveItem($id: ID!, $productId: ID!) {\n  cartRemoveItem(id: $id, productId: $productId) {\n    id\n    items {\n      quantity\n      product {\n        id\n        name\n        description\n        price\n        categories {\n          name\n        }\n        images {\n          url\n        }\n      }\n    }\n  }\n}",
 ...
 */
export function graphql(
	source: "query CategoryGetProducts($slug: String!) {\n  category(slug: $slug) {\n    name\n    products {\n      ...ProductsListItem\n    }\n  }\n}",
): typeof import("./graphql").CategoryGetProductsDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "query CategoriesGet($skip: Int, $take: Int) {\n  categories(skip: $skip, take: $take) {\n    data {\n      id\n      name\n      slug\n    }\n    meta {\n      count\n      total\n    }\n  }\n}",
 ...
 */
export function graphql(
	source: "query CollectionGetProducts($slug: String!) {\n  collection(slug: $slug) {\n    name\n    products {\n      ...ProductsListItem\n    }\n  }\n}",
): typeof import("./graphql").CollectionGetProductsDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "fragment CollectionData on Collection {\n  id\n  name\n  slug\n}",
): typeof import("./graphql").CollectionDataFragmentDoc;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "query CollectionsGet {\n  collections {\n    data {\n      ...CollectionData\n    }\n    meta {\n      total\n    }\n  }\n}",
 ...
 */
export function graphql(
	source: "fragment ProductDetailsWithCategories on Product {\n  ...ProductDetails\n  categories {\n    name\n  }\n}",
): typeof import("./graphql").ProductDetailsWithCategoriesFragmentDoc;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "query ProductDetailsWithCategoriesGetById($id: ID!) {\n  product(id: $id) {\n    ...ProductDetailsWithCategories\n  }\n}",
 ...
 */
export function graphql(
	source: "query ProductGetRelated {\n  products(take: 4) {\n    data {\n      ...ProductsListItem\n    }\n  }\n}",
): typeof import("./graphql").ProductGetRelatedDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "query ProductsGet($search: String, $take: Int, $skip: Int, $order: SortDirection, $orderBy: ProductSortBy) {\n  products(\n    search: $search\n    take: $take\n    skip: $skip\n    order: $order\n    orderBy: $orderBy\n  ) {\n    data {\n      ...ProductsListItem\n    }\n    meta {\n      total\n      count\n    }\n  }\n}",
 ...
 */
export function graphql(
	source: "query CategoriesGetMenuItems {\n  categories {\n    data {\n      name\n      slug\n    }\n  }\n}",
): typeof import("./graphql").CategoriesGetMenuItemsDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "query CollectionsGetMenuItems {\n  collections {\n    data {\n      name\n      slug\n    }\n  }\n}",
 ...
 */
export function graphql(
	source: "fragment ReviewData on Product {\n  rating\n  reviews {\n    ...Review\n  }\n}",
 ...
 */
export function graphql(
	source: "query ReviewsGetByProductId($id: ID!) {\n  product(id: $id) {\n    ...ReviewData\n  }\n}",
